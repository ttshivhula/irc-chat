...
/*   Updated: 2018/08/30 10:28:05 by ttshivhu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		group_all_private(t_server *server, t_clients *client, int private,
		int to_fd)
{
	int	i;
...
int		broadcast_action(t_server *server, t_clients *client, int action,
		char *nick)
{
	int	i;
